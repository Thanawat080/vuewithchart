          ...
          <div class="input">Add to your post
            <div class="image-upload" style="margin-left: 250px;">
              <label for="file-input">
                <img src="https://static.xx.fbcdn.net/rsrc.php/v3/yC/r/a6OjkIIE-R0.png?_nc_eui2=AeEROHNgEIeAgmIkEz0Cir2CfK5Z1qDG7FV8rlnWoMbsVRBub7G9sWD6iVVh0J5TdGt_1i-OnVJ_PSthRF33l8_A" style=" height: 24px; cursor: pointer;"/>
              </label>
